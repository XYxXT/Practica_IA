...
class Node:
    ...
    def setHeuristic(self, typePreference, node_destination,city):
        ...
        if typePreference == 1:
            ...
            #distance1 = self.station.x + node_destination.station.x
            #distance2 = self.station.y + node_destination.station.y
            ...
            #self.h = sqrt(abs(distance1 - distance2))/city.max_velocity #TODO use float values (use velocity mean instead of max)                
